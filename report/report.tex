...
\begin{document}
	...
	\frame {
		...
		\begin{itemize}
			\item Корреляция оценок зрителей и критиков
			\item Корреляция рейтинга КиноПоиска и рейтинга IMDb
	...
	\frame {
		\frametitle{Корреляция оценок зрителей и критиков}
		\begin{center}
	...
	\frame {
		\frametitle{Корреляция рейтинга КиноПоиска и рейтинга IMDb}
		\begin{center}
